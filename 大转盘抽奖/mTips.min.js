        ...
        _create: function() {
            if (!this.BG) {
                var a = document.getElementsByTagName("body")[0]
                  , b = '<div id="aTips_box"><a onclick="hide2()" style="float: right;margin-top: -21%;width: 13%;height: 42px;color: transparent;">确定</a><div id="aTips_content"></div><div id="aTips_contents">泰克115补片1桶</div><div id="aTips_foot"><a href="javascript:;" id="aTips_cancel" style="display: none">取消</a><a href="javascript:;" id="aTips_defines">确定</a></div></div>';
...
//              this.define = this.$("#aTips_define"),
                this.defines = this.$("#aTips_defines"),
                this.cancel = this.$("#aTips_cancel"),           
                this.defines.onclick = function() {
...
//      },
        _cancel: function(a) {
            ...
            this.cancel.onclick = function(c) {
                ...
                b._hide(),
                b.Bool = !1,
                "function" == typeof a ? void (a && a(b.Bool)) : void (a.after && a.after(b.Bool))
            }
        },
        _bind: function() {
            this.BG.focus(),
...
//          }),
        ...
        _setBtn: function(a, b) {
            switch (this.foot.style.display = "block",
//          this.define.style.display = "",
            ...
            case 1:
                ...
                "function" == typeof b ? (this.define.innerText = "确定",
                this._define(function() {
                    b && b()
                })) : (this.define.innerText = b.define || "确定",
                this._define(b));
                break;
            case 2:
                ...
                this._define(function(a) {
                    b && b(a)
                }),
                this._cancel(function(a) {
                    b && b(a)
                })) : (this.define.innerText = b.define || "确定",
                this.cancel.innerText = b.cancel || "取消",
                this._define(b),
                this._cancel(b));
                break;
            case 0:
        ...
        _setOption: function(a, b, c) {
            var d = "";
            this._create(),
            "string" == typeof a || "number" == typeof a ? (d = a || "",
            this._setBtn(b, function(a) {
                c && c(a)
            })) : (a = a || {},
            d = a.content || "",
            this._setBtn(b, a)),
        ...
        _setTime: function(a, b) {
            var c = 0
              , d = this;
            c = "string" == typeof a ? b : a.time,
            parseInt(c) > 0 && (this._timer = setTimeout(function() {
                d._hide()
            }, 1e3 * c))
        },
        _create2: function() {
