                ...
                if (b.target === c.wrapper) {
                    ...
                    if (c.loop && (l += 1),
                        ...
                        for (var g = 0, h = f.length; h > g; g++) {
                            ...
                            // 控制文字和按钮显示隐藏功能
                            g===l?k.getElementsByTagName("p")[1].style.display="block":k.getElementsByTagName("p")[1].style.display="none";
                            g===l?k.getElementsByTagName("div")[1].style.display="block":k.getElementsByTagName("div")[1].style.display="none";
                        }
